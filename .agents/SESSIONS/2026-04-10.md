# 2026-04-10 — ShipCode: Docs Migration + Vercel Deployment + Release Automation + Configurable Worktree Root + PRD Architecture + Mandatory-GitHub Refactor + Kanban Status Colors + 4-Column Kanban Refactor + Per-Issue Executor Dropdown + Cross-Agent Memory System + IssueDetail Dialog Overlay + AI-First CreateIssueModal
