      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-secondary border border-border rounded-xl overflow-hidden">
          ...
          <div className="flex items-center gap-2 px-4 py-3 bg-tertiary border-b border-border">
            ...
            <span className="ml-3 text-sm text-muted font-mono">shipcode run 42</span>
          </div>
          {/* Terminal content */}
          <pre className="px-6 py-5 font-mono text-sm leading-relaxed overflow-x-auto">
            ...
            <Line text="" />
            <Line text="Shipping..." />
            <Line text="PR #43 created → github.com/acme/app/pull/43" check />
          </pre>
        </div>
      </div>
    </section>
...
function Line({ text, check, warn }: { text: string; check?: boolean; warn?: boolean }) {
