...
These are defined in [`packages/agents/src/github/model-router.ts`](https://github.com/shipshitdev/shipcode/blob/master/packages/agents/src/github/model-router.ts). Unknown or missing agent labels fall back to `shipcode:agent:claude`.
