...
|-------|---------------|--------------|
| **Plan** | Claude (Sonnet 4.6 default) | Rewrites the issue into a spec and structured plan |
...
| **Verify** | Claude (Sonnet 4.6 default) — set during onboarding | Checks the diff, test output, and acceptance criteria |
