...
| Cursor CLI | `auto` | — | — | ✓ | — |
| Grok CLI | `grok-4.5` | — | — | ✓ | — |
| OpenRouter | `openrouter/auto`, `openrouter/free`, `anthropic/claude-sonnet-4.6`, `anthropic/claude-opus-4.8`, `anthropic/claude-fable-5`, `openai/gpt-5.6-sol`, `openai/gpt-5.6-terra`, `openai/gpt-5.6-luna`, `qwen/qwen3.6-plus`, `qwen/qwen3-coder:free` | ✓ | ✓ | ✓ | ✓ |
