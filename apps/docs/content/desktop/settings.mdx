...
| `worktreeBranchFormat` | `shipcode/{id}-{slug}` | Branch template for generated issue worktree branches (non-issue worktrees use `shipcode/{slug}`) |
...
| `triageModel` | `claude` | Provider for board review / Backlog triage |
