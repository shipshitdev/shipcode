...
import { PlanViewer, ReviewViewer, Badge, Button, Textarea, X, ExternalLink, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, getStatusBadgeVariant } from '@shipcode/ui'
	...
	return (
		<div className="h-full flex flex-col overflow-y-auto bg-primary">
				...
				<div className="relative shrink-0 border-b border-border p-4">
					<button
						type="button"
						className="absolute right-3 top-3 flex h-6 w-6 cursor-pointer items-center justify-center rounded-md border-none bg-transparent text-muted hover:bg-hover hover:text-primary"
