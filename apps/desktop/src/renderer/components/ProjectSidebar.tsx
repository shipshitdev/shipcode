...
export function ProjectSidebar() {
	const { activeProjectId, viewMode, settingsVisible, selectProject, openDashboard, openActivity, openInbox, openCosts, sidebarCollapsed } = useAppStore()
		...
		<aside className="flex w-[256px] min-w-[256px] flex-col border-r border-border bg-primary">
			...
			<div className="px-2 space-y-0.5">
				...
				<button
					...
					onClick={() => openCosts()}
				>
					<svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="shrink-0 text-secondary">
