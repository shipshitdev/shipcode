 ...
 *
 * The shared transport has no stdin channel, so this is the one place in the
 * module that spawns git directly — used solely for `update-ref --stdin`,
 * whose batch form has no argv equivalent.
 */
