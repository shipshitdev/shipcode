...
const VALID_PLAN = {
	...
	steps: [
		{ order: 1, description: 'Do thing', files: ['src/foo.ts'], rationale: 'Because' },
	],
...
const VALID_REVIEW = {
	...
	summary: 'Looks good',
	findings: [
		{ id: 'f1', severity: 'minor', category: 'design', description: 'Consider X' },
	],
	suggestedChanges: [],
}
...
const VALID_VERIFICATION = {
	...
	summary: 'All good',
	criteriaResults: [
		{ criterion: 'Tests pass', passed: true, evidence: 'All green' },
	],
	issues: [],
}
