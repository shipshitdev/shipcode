...
export class DashboardQueries {
  ...
  getStats(): DashboardStats {
    ...
    const agentsRunningRow = this.db.prepare(
    ...
    const perPhaseRows = this.db.prepare(
    ...
    const tasksInProgressRow = this.db.prepare(
    ...
    const tasksOpenRow = this.db.prepare(
    ...
    const shippedRow = this.db.prepare(
      `SELECT COUNT(*) as n FROM threads
